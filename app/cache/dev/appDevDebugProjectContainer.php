...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'ws_woodstack.component.authentication.handler.login_success_handler' => 'getWsWoodstack_Component_Authentication_Handler_LoginSuccessHandlerService',
            'ws_woodstack.component.authentication.handler.logout_success_handler' => 'getWsWoodstack_Component_Authentication_Handler_LogoutSuccessHandlerService',
        );
        $this->aliases = array(
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'symfony', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/OC/PlatformBundle/Entity'), 1 => ($this->targetDirs[3].'/src/WS/WoodstackBundle/Entity')));

        $d = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $d->addDriver($b, 'FOS\\UserBundle\\Entity');
        $d->addDriver($c, 'OC\\PlatformBundle\\Entity');
        $d->addDriver($c, 'WS\\WoodstackBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'OCPlatformBundle' => 'OC\\PlatformBundle\\Entity', 'WSWoodstackBundle' => 'WS\\WoodstackBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_1db12708b901c5e3888b909ed13f3d7bdd2edd6bc2c9bd5f818f1fe8f00d6b0b');
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('WS\\WoodstackBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('WS\\WoodstackBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'WS\\WoodstackBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k->add($i, array(0 => 'IS_AUTHENTYCATED_ANONYMOUSLY'), NULL);
        $k->add($j, array(0 => 'ROLE_ADMIN'), NULL);

        $l = new \Symfony\Component\Security\Http\HttpUtils($d, $d);

        $m = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $l, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($l, '/woodstack'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/woodstack/logout'));
        ...
        $n->setOptions(array('login_path' => '/woodstack/login', 'always_use_default_target_path' => true, 'default_target_path' => '/woodstack', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $o->setOptions(array('login_path' => '/woodstack/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($k, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username')), 'main', $a, $c), 2 => $m, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $l, 'main', $n, $o, array('check_path' => '/woodstack/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, $this->get('security.csrf.token_manager')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '56e1782a8b6e73.22997815', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $k, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $l, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $l, '/woodstack/login', false), NULL, NULL, $a, false));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/WS/WoodstackBundle/Resources/views'), 'WSWoodstack');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('c3759e19f7a69812e4f2625f3699d4be2c7243d2');
    }
    ...
    /**
     * Gets the 'ws_woodstack.component.authentication.handler.login_success_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \WS\WoodstackBundle\Component\Authentication\Handler\LoginSuccessHandler A WS\WoodstackBundle\Component\Authentication\Handler\LoginSuccessHandler instance.
     */
    protected function getWsWoodstack_Component_Authentication_Handler_LoginSuccessHandlerService()
    {
        return $this->services['ws_woodstack.component.authentication.handler.login_success_handler'] = new \WS\WoodstackBundle\Component\Authentication\Handler\LoginSuccessHandler($this, $this->get('router'), $this->get('security.context'));
    }

    /**
     * Gets the 'ws_woodstack.component.authentication.handler.logout_success_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \WS\WoodstackBundle\Component\Authentication\Handler\LogoutSuccessHandler A WS\WoodstackBundle\Component\Authentication\Handler\LogoutSuccessHandler instance.
     */
    protected function getWsWoodstack_Component_Authentication_Handler_LogoutSuccessHandlerService()
    {
        return $this->services['ws_woodstack.component.authentication.handler.logout_success_handler'] = new \WS\WoodstackBundle\Component\Authentication\Handler\LogoutSuccessHandler($this, $this->get('router'));
    }
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('main', '/woodstack/logout', 'logout', '_csrf_token', NULL);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'WSWoodstackBundle' => 'WS\\WoodstackBundle\\WSWoodstackBundle',
            ...
            'secret' => 'c3759e19f7a69812e4f2625f3699d4be2c7243d2',
            'locale' => 'en',
            ...
            'kernel.secret' => 'c3759e19f7a69812e4f2625f3699d4be2c7243d2',
            ...
            'fos_user.model.user.class' => 'WS\\WoodstackBundle\\Entity\\User',
